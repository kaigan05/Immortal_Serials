...
namespace ImmortalSerials
{
    public class Evader
    {
        public List<Skillshot> DetectedSkillShots = new List<Skillshot>();
        public Evader()
        {
            SkillshotDetector.OnDetectSkillshot += OnDetectSkillshot;
            SkillshotDetector.OnDeleteMissile += OnDeleteMissile;
            Game.OnGameUpdate += args => DetectedSkillShots.RemoveAll(skillshot => !skillshot.IsActive());
        }
        /// <summary>
        ...
        {
            return DetectedSkillShots.Any(skillshot => !skillshot.IsDanger(point));
        }
        ...
        private void OnDetectSkillshot(Skillshot skillshot)
        {
            ...
            if (skillshot.Unit.Team == ObjectManager.Player.Team && !SkillshotDetector.Debug)
            {
                return;
            }
                    ...
                    if (skillshot.SpellData.SpellName == "SyndraE" || skillshot.SpellData.SpellName == "syndrae5")
                    {
                        ...
                        foreach (var minion in ObjectManager.Get<Obj_AI_Minion>())
                        {
                            ...
                            if (minion.Name == "Seed" && edge1.CrossProduct(v) > 0 && v.CrossProduct(edge2) > 0 &&
                                ...
                                (minion.Team != ObjectManager.Player.Team||SkillshotDetector.Debug))
                            {
        ...
        private void OnDeleteMissile(Skillshot skillshot, Obj_SpellMissile missile)
        {
